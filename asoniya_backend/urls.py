...
urlpatterns = [
    ...
    path('car-rentals/<int:rental_id>/', views.car_rental_detail_page, name='car_rental_detail'),
    path('profile/', views.profile_page, name='profile'),
    path('trip-summary/', views.trip_summary_page, name='trip_summary'),
    path('trip/<int:trip_id>/', views.view_saved_trip_page, name='view_saved_trip'),
